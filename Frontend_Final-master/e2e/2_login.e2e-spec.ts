...
describe("login page", () => {
  ...
  it("should get username input box", () => {
    ...
    expect(page.isUserNameInputBoxPresent()).toBeTruthy(
  ...
  it("default values of username and password should be empty", () => {
    ...
    page.navigateToLogin();
    expect(page.getLoginInputBoxesDefaultValues()).toEqual(
      emptyLoginValues,
  ...
  it("should login into the system", () => {
    ...
    expect(page.getLoginInputBoxesDefaultValues()).toEqual(
      newNoteValues,
      "Should be able to set values for username and password"
    );
    ...
    page.getCurrentURL().then(url => {
      if (url.indexOf("login") > -1) {
        ...
        expect(page.getCurrentURL()).toContain(
          ...
          "Should navigate to note view dashboard"
        );
      } else {
        expect(page.getCurrentURL()).toContain(
          "dashboard/view/noteview",
